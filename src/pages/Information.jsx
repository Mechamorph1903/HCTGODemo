    ...
    return(
        <div className="p-6 text-black dark:text-white">
            <div className="flex gap-5 flex-col">
                ...
                <div className="bg-slate-50 dark:bg-slate-800 rounded-2xl p-5 border border-slate-100 dark:border-slate-800">
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-400 dark:text-slate-500">All riders unless eligible for reduced or free fare</p>
                        </div>
                        ...
                        <div className="flex justify-between items-start py-3 border-b border-slate-100 dark:border-slate-800 last:border-0">
                            <div>
                                ...
                                <p className="text-xs text-slate-400 dark:text-slate-500">Children (ages 5—highschool) • Seniors (62+) • Disabled with ID • HCT ID and Medicare</p>
                            </div>
                        ...
                        <div className="flex justify-between items-start py-3 border-b border-slate-100 dark:border-slate-800 last:border-0">
                            <div>
                                ...
                                <p className="text-xs text-slate-400 dark:text-slate-500">Southern Miss. students and City of Hattiesburg Employees</p>
                            </div>
                            <span className="font-bold text-lg">$0.00</span>
                        </div>                     
                    </div>

                    <div className="mt-4 bg-blue-50 dark:bg-blue-950 border border-blue-100 dark:border-blue-900 rounded-xl p-4 text-sm text-blue-800 dark:text-blue-200">
                ...
                <div className="bg-slate-50 dark:bg-slate-800 rounded-2xl p-5 border border-slate-100 dark:border-slate-800">
                    ...
                    <p>
                        ...
                        <span className="mt-4 bg-blue-50 dark:bg-blue-950 border border-blue-100 dark:border-blue-900 rounded-xl p-4 text-sm text-blue-800 dark:text-blue-200 inline-block">Buses do not run on the following holidays: <strong>New Year's Day, Martin Luther King Jr. Day, Good Friday, Memorial Day, Fourth July, 
                ...
                <div className="bg-slate-50 dark:bg-slate-800 rounded-2xl p-5 border border-slate-100 dark:border-slate-800">
                    ...
                    <a href="https://hubcitytransit.com/paratransit/" className="inline-flex items-center justify-center h-10 w-40 border border-blue-500 rounded-lg mt-4 text-blue-500 dark:text-blue-400 text-sm font-medium ">More Information</a>
                </div>
            </div>
        </div>
    )
